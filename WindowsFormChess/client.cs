...
namespace Sakk_Alkalmazás_2._0
{
    public partial class client : Form
    {
        ...
        private ManualResetEvent clearMessageReceived;
        public client()
        {
            InitializeComponent();
            clientRunning = false;
            clearMessageReceived = new ManualResetEvent(false); // Initialize the event as not set
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (!clientRunning)
            {
                ...
                clientSocket.Connect(IPAddress.Parse("10.45.135.161"), 20000);
        ...
        private void ReceiveMessages()
        {
            while (clientRunning & !inroom)
            {
                ...
                {
                    clearMessageReceived.Set(); // Signal that clear message is received
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            inroom = true;
            send_message("create");
            MessageBox.Show("Wait for other player to connect");
            // Wait until clear message is received
            clearMessageReceived.WaitOne();
            // Reset the event for future use
            clearMessageReceived.Reset();
